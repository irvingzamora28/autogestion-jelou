            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="pt-3">
                        ...
                        <img src="{{URL::asset('assets/images/small/business.png')}}" alt="" class="img-fluid px-3 mb-2">
                    </div>
                </div>
                <!--end card-body-->
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive browser_users">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{URL::asset('assets/images/logos/chrome.png')}}" alt="" height="20" class="me-2">Chrome</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{URL::asset('assets/images/logos/micro-edge.png')}}" alt="" height="20" class="me-2">Microsoft Edge</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{URL::asset('assets/images/logos/in-explorer.png')}}" alt="" height="20" class="me-2">Internet-Explorer</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td><img src="{{URL::asset('assets/images/logos/opera.png')}}" alt="" height="20" class="me-2">Opera</td>

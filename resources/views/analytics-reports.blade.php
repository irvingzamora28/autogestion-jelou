    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{URL::asset('assets/images/flags/us_flag.jpg')}}" class="me-3 thumb-md align-self-center rounded" alt="...">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{URL::asset('assets/images/flags/germany_flag.jpg')}}" class="me-3 thumb-md align-self-center rounded" alt="...">
                        <div class="media-body align-self-center">
                            <div class="coin-bal">
                                <h4 class="mt-0 mb-1 font-22 fw-bold">50,289</h4>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{URL::asset('assets/images/flags/spain_flag.jpg')}}" class="me-3 thumb-md align-self-center rounded" alt="...">
                        <div class="media-body align-self-center">
                            <div class="coin-bal">
                                <h4 class="mt-0 mb-1 font-22 fw-bold">50,289</h4>

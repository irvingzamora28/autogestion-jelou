                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                                ...
                                                <div class="m-3 text-center text-muted">
                                                    <p class="">Don't have an account ? <a href="auth-register" class="text-primary ml-2">Free Resister</a></p>
                                                </div>
                                            ...
                                            <div class="tab-pane px-3 pt-3" id="Register_Tab" role="tabpanel">
                                                ...
                                                <!--end form-->
                                                <div class="m-3 text-center text-muted">
                                                    <p class="mb-0 text-muted">Already have an account ?<a href="auth-login" class="text-primary ml-2">Log in</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="">
                                                <div class="px-3">
                                                    <div class="auth-logo-box text-center">
                                                        <a href="analytics-index" class="logo logo-admin"><img src="{{URL::asset('assets/images/logo-sm.png')}}" height="40" alt="logo" class="auth-logo"></a>
                                                    </div>
                                                    <!--end auth-logo-box-->
                                                ...
                                                <div class="m-3 text-center text-muted">
                                                    <p class="">Already have an account ? <a href="auth-login" class="text-primary ml-2">Log in</a></p>
                                                </div>
                                            </div>
                                            <!--end card-body-->
                                        </div>

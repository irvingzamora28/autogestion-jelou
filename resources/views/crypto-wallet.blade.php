                            ...
                            <div class="tab-content my-4">
                                <div class="tab-pane active" id="wallet_BTC" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 col-lg">
                                            <div class="media">
                                                <img src="{{URL::asset('assets/images/logos/btc.png')}}" class="me-2 thumb-md align-self-center rounded-circle" alt="...">
                                                <div class="media-body align-self-center">
                                ...
                                <div class="tab-pane" id="wallet_ETH" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="media">
                                                <img src="{{URL::asset('assets/images/logos/eth.png')}}" class="me-2 thumb-md align-self-center rounded-circle" alt="...">
                                                <div class="media-body align-self-center">
                                ...
                                <div class="tab-pane" id="wallet_DASH" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="media">
                                                <img src="{{URL::asset('assets/images/logos/dash.png')}}" class="me-2 thumb-md align-self-center rounded-circle" alt="...">
                                                <div class="media-body align-self-center">
                                ...
                                <div class="tab-pane" id="wallet_LTC" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="media">
                                                <img src="{{URL::asset('assets/images/logos/lite.png')}}" class="me-2 thumb-md align-self-center rounded-circle" alt="...">
                                                <div class="media-body align-self-center">
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                <img src="{{URL::asset('assets/images/small/cry_logo.png')}}" alt="" class="" height="30">
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="media">
                                <img src="{{URL::asset('assets/images/small/cry_logo-2.png')}}" alt="" class="" height="30">
                                <div class="media-body align-self-center ms-2">

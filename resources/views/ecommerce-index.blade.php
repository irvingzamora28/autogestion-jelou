...
@section('body-start') <body id="body" class="dark-sidebar"> @endsection
    ...
    <div class="row">
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/04.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
        ...
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/01.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/02.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/03.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/05.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-lg-2 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/products/06.png')}}" alt="" class="img-fluid px-2 px-lg-5">
                    <hr class="hr-dashed">
                    <div class="d-flex justify-content-between">
                        <div>

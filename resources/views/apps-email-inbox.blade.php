                ...
                <div class="row mb-3">
                    ...
                    <div class="col-5">
                        <div class="btn-group float-end">
                            <button type="button" class="btn  btn-de-secondary waves-effect mb-0"><i class="fa fa-chevron-left"></i></button>
                            <button type="button" class="btn  btn-de-secondary waves-effect mb-0"><i class="fa fa-chevron-right"></i></button>
                        </div>
                    </div><!-- end Col -->
                </div>
                <!--end row-->
    ...
    <script>
        ...
        document.querySelectorAll('li').forEach(function (element){
            element.addEventListener('click', function(event){
                document.querySelectorAll('input:not(:checked)').forEach(function(unchecked){
                    unchecked.parentElement.parentElement.parentElement.classList.remove('unread');
                });
                document.querySelectorAll('input:checked').forEach(function(unchecked){
                    unchecked.parentElement.parentElement.parentElement.classList.add('unread');
                });    
            })
        });
        document.querySelectorAll('input:checked').forEach(function(unchecked){

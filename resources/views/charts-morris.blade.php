...
@endsection
@section('body-start') <body onload="body()" id="body" class="dark-sidebar"> @endsection
    @section('content')
    <!-- page title-->
    @section('breadcrumb')
    @component('components.breadcrumb')
    @slot('li_1') Charts @endslot
    @slot('title') Morris @endslot
    @endcomponent
    @endsection
    ...
    <div class="modal modal-rightbar fade" id="UnikitRightbar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">

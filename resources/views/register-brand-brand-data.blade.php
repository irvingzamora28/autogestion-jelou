                        ...
                        <div class="col-6">
                            ...
                            <form>
                                <div class="form-group row mb-3">
                                    <div class="col-sm-6">
                                        <label for="brand_name" class="form-label">Nombre o Razón Social</label>
                                        <input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="Nombre o Razón Social">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row mb-3">
                                    <div class="col-sm-6">
                                        <label for="brand_country" class="form-label">País</label>
                                        <input type="text" class="form-control" name="brand_country" id="brand_country" placeholder="País">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="brand_description" class="form-control" id="brand_description" cols="30" rows="4" placeholder="Descripción"></textarea>
                                </div>

                                <div class="form-group row mb-3">
                                    <div class="col-sm-6">
                                        <label for="brand_telephone" class="form-label">Numero Teléfonico</label>
                                        <input type="text" class="form-control" name="brand_telephone" id="brand_telephone" placeholder="Numero Teléfonico">
                                    </div>
                                </div>
                                <div class="mb-3">
                                        ...
                                        <table class="table mb-0">
                                            <thead>
                                                <tr class="border-bottom">
                                                    ...
                                                    <th scope="col" class="text-center">Tasa de conversión<br>(a dólar)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                ...
                                <div class="form-group row mb-3">
                                    <label for="" class="form-label">Contacto técnico</label>
                                    <div class="col-sm-6">

                ...
                <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="sidebarCrypto">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="crypto-index">Dashboard</a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="sidebarProjects">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="projects-index">Dashboard</a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse " id="sidebarEcommerce">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="ecommerce-index">Dashboard</a>
                                </li><!--end nav-item-->
                                <li class="nav-item">
                ...
                <ul class="navbar-nav tab-pane" id="Extra" role="tabpanel">
                    <li>
                        <div class="update-msg text-center position-relative">
                            ...
                            <img src="{{URL::asset('assets/images/speaker-light.png')}}" alt="" class="" height="110">

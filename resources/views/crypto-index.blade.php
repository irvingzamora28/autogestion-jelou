...
@section('body-start') <body id="body" class="dark-sidebar"> @endsection
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/logos/btc.png')}}" class="thumb-lg align-self-center img-thumbnail rounded-circle mb-2" alt="...">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/logos/eth.png')}}" class="thumb-lg align-self-center img-thumbnail rounded-circle mb-2" alt="...">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/logos/lite.png')}}" class="thumb-lg align-self-center img-thumbnail rounded-circle mb-2" alt="...">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <img src="{{URL::asset('assets/images/logos/dash.png')}}" class="thumb-lg align-self-center img-thumbnail rounded-circle mb-2" alt="...">
